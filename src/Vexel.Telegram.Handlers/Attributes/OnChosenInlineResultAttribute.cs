...
/// <summary>
/// Marks an Immediate.Handlers handler as a ChosenInlineResult observer in the On* fan-out.
...
/// Request shape must be an empty record; inject <c>ChosenInlineResultContext</c> / <c>Feedback</c>
/// for payload access.
/// Fire-and-forget is deferred post-2.0; this attribute stays shape-compatible with a later opt-in.
/// </remarks>
[AttributeUsage(AttributeTargets.Class, AllowMultiple = false, Inherited = false)]
public sealed class OnChosenInlineResultAttribute : Attribute;
