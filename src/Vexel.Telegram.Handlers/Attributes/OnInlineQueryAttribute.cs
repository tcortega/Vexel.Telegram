...
/// <summary>
/// Marks an Immediate.Handlers handler as an InlineQuery observer in the On* fan-out.
...
/// Request shape must be an empty record; inject <c>InlineQueryContext</c> / <c>Feedback</c> for payload access.
/// Fire-and-forget is deferred post-2.0; this attribute stays shape-compatible with a later opt-in.
/// </remarks>
[AttributeUsage(AttributeTargets.Class, AllowMultiple = false, Inherited = false)]
public sealed class OnInlineQueryAttribute : Attribute;
