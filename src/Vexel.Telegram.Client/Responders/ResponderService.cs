...
{
	private readonly Dictionary<Type, List<Type>> _registeredEarlyResponderTypes = [];
	private readonly Dictionary<Type, List<Type>> _registeredResponderTypes = [];
	private readonly Dictionary<Type, List<Type>> _registeredLateResponderTypes = [];
	...
	)
	{
		...
		return responderGroup.TryGetValue(typeKey, out var typedResponderTypes)
			? [.. anyResponderTypes, .. typedResponderTypes]
			: anyResponderTypes;
	}
}
